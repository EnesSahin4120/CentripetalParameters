...
{
    [Serializable]
    public partial class WheelGroupSelector
    {
        public int index;
    }
}
...
namespace NWH.VehiclePhysics2.Powertrain.Wheel
{
    ...
    public partial class WheelGroupSelectorDrawer : NVP_NUIPropertyDrawer
    {
        ...
        {
            return NUISettings.fieldHeight;
        }
        ...
        public override bool OnNUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            selectedIndex = EditorGUI.Popup(new Rect(rect.x, rect.y, rect.width, NUISettings.fieldHeight),
