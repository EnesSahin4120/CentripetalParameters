        ...
        public override void Update()
        {
            ...
            if (vc.powertrain.Active && vc.powertrain.engine.IsRunning)
            {
                ...
                foreach (ParticleSystem ps in particleSystems)
                {
                    ...
                    float speedLifetime = _vehicleSpeed < 0.2f && _vehicleSpeed > -0.2f
                                              ? 0
                                              : lifetimeDistance / _vehicleSpeed;
                    float lifetime = Mathf.Lerp(_initLifetime, speedLifetime, _absVehicleSpeed * 0.5f);
