...
namespace NWH.Common.SceneManagement
{
    ...
    public class VehicleChanger : MonoBehaviour
    {
        ...
        /// <summary>
        /// Set to true for the script to automatically find vehicles in the scene(s).
        /// Vehicles will register themselves on their respective Awake() calls.
        /// </summary>
        public bool autoFindVehicles = true;
        ...
        public void EnterVehicle(Vehicle v)
        {
            ...
            VehicleChanger.Instance.ChangeVehicle(v);
        }
...
namespace NWH.Common.SceneManagement
{
    ...
    public class VehicleChangerEditor : NUIEditor
    {
        public override bool OnInspectorNUI()
        {
            ...
            if (drawer.Field("autoFindVehicles").boolValue)
            {
                drawer.Info("When autoFindVehicles is enabled only the vehicles that have 'Register With Vehicle Changer' will be found.");
            }
